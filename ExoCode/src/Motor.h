...
class _Motor
{
	public:
        ...
        virtual void clear_error() { _error = false; }   /**< Clears a latched motor fault. */
...
class _CANMotor : public _Motor
{
    ...
    protected:
        ...
        uint32_t _last_diag_ms = 0;   /**< SIMPLE_DEBUG telemetry rate limiter. */
        uint32_t _rx_count = 0;      /**< Feedback frames received FROM this specific motor. */
