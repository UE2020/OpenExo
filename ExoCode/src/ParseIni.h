...
namespace config_defs
{
    ...
    {
        //Byte format : [arm_2, is_left, !is_left, arm_1, is_elbow, is_hip, is_knee, is_ankle]
        left = 0b01000000,
        right = 0b00100000,
        ...
        left_hip = left|hip,                //Set Motor ID to: 68
        left_knee = left|knee,              //Set Motor ID to: 66
        left_ankle = left|ankle,            //Set Motor ID to: 65
        ...
        right_hip = right|hip,              //Set Motor ID to: 36
        right_knee = right|knee,            //Set Motor ID to: 34
        right_ankle = right|ankle,          //Set Motor ID to: 33
